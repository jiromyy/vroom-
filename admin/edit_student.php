        ...
        <div class="main-content">
            ...
            <div id="editModal" class="modal">
                ...
                <div class="modal-content">
                    ...
                    <?php include('get_student_id.php')?>
                    ...
                    <div class="modal-body">
                        <form class="update-form" action="" method="POST">
                            ...
                            <div>
                                <button class="form-btn update" type="submit" name="update_student">UPDATE</button>
                                <button class="form-btn cancel" type="submit" onclick="location.href='students.php';">CANCEL</button>
                            </div>
                        </form>
                    </div>
                </div>
